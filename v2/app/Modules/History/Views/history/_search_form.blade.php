<div class="navbar navbar-default">
    ...
    <div class="collapse navbar-collapse filter" style="padding-top: 10px;">
        ...
        {!! Former::open()->method('GET')->action(route('history.index'))->dataPjax() !!}
            <div class="row">
                <div class="col-lg-10 col-md-8">{!! Former::text('message')->label('Filter history') !!}</div>
                <div class="col-lg-2 col-md-4">
                    ...
                    <div class="col-md-6 col-sm-6 col-xs-6">
                        <div class="form-group">
                            {!! Former::label('&nbsp;') !!}
                            {!! Html::decode(Former::default_link('<i class="fa fa-remove"></i>', route('history.index'))->addClass('form-control')) !!}
                        </div>
                    </div>
                </div>
            </div>
