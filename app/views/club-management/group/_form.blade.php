...
<div class="row">
    ...
    <div class="col-md-6">
        {{ Former::textarea('description')->rows(10)->help('* Here you can write anything you want about this member group. For example who is working on this location and with this group.') }}
    </div>
</div>
